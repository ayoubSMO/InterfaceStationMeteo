      ...
      <div class="container-fluid">
        ...
        @endif
          <div class="card-header card-header-primary">
            <h4 class="card-title">Convocation Controll</h4>
            ...
            <div class="table-responsive">
              <table class="table">
                <thead class=" text-primary-bold font-weight-bold">
                    ...
                    {!!Form::open(['action' => ['App\Http\Controllers\controllConvocationController@update', $convocation->id_convocation], 'method' => 'PUT', 'class' => 'pull-center'])!!}
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {{$convocation->Année_universitaire}}
                    </td>
                    <td>
                        {{ Form::dateTime('dateOuverture', $convocation->dateOuverture, ['class' => 'form-control']) }}
                    </td>
                    <td class="font-weight-bold" style="color:rgba(255, 0, 0, 0.623)">
                        {{ Form::dateTime('dateFermeture', $convocation->dateFermeture, ['class' => 'form-control']) }}
                    </td>
                    <td >
                        {{Form::checkbox('ouvertureFermeture','on', $convocation->etat)}}
                      <td >
