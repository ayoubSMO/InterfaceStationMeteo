      ...
      <div class="container-fluid">
        <div class="card card-plain">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Creation d'un examen</h4>
            <p class="card-category">System d'administration FPS
              <a target="_blank" href="https://www.uca.ma/fps">FPS</a>
            </p>
          </div>
          <div class="card-body">
            {!! Form::open(['action' => 'App\Http\Controllers\addExamenController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            <div class="table-responsive">
                ...
                <tbody>
                  <tr>
                    <td>
                        {!! Form::select('saison', ['PRINTEMPS','AUTOMNS'],'AUTOMNS' , ['class' => 'form-control']) !!}
                    </td>
                    <td>
                        {!! Form::select('session', ['normal','rattrappage'],'normal' , ['class' => 'form-control']) !!}
                    </td> 
                    <td>
                        {!! Form::text('Année_universitaire', '2020-2021',['class' => 'form-control']) !!}
                    </td> 
                    <td>
                        {!! Form::dateTime('dateOuverture', $sysdate, ['class' => 'form-control']) !!}
                    </td>
                    <td class="font-weight-bold" style="color:rgba(255, 0, 0, 0.623)">
                        {!! Form::dateTime('dateFermeture', $sysdate, ['class' => 'form-control']) !!}
                    </td>
                    <td >
                        {{Form::checkbox('ouvertureFermeture','on', false)}}
                    <td>
